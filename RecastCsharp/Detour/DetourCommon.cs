...
namespace RecastSharp
{
    ...
    public static unsafe class DetourCommon
    {
        ...
        */
        ...
        {
            return dtIntersectSegmentPoly2D(new ReadOnlySpan<float>(p0, 3), new ReadOnlySpan<float>(p1, 3), new ReadOnlySpan<float>(verts, 18), nverts, ref tmin, ref tmax, ref segMin, ref segMax);
        }
        ...
        {
            return dtPointInPolygon(new ReadOnlySpan<float>(pt, 3), new ReadOnlySpan<float>(verts, DT_VERTS_PER_POLYGON * 3), nverts);
        }
        ...
        {
            return dtDistancePtPolyEdgesSqr(new ReadOnlySpan<float>(pt, 3), new ReadOnlySpan<float>(verts, 18), nverts, new Span<float>(ed, nverts), new Span<float>(et, nverts));
        }
